...
/**
 * Finds the next grain index in order of the selected track.
 * 
...
const getNextGrainIndexCore = (
  ...
  const nextGrainIndex: number = clamp(candidate, lowerBound, upperBound);
  // Return next grain index
  return nextGrainIndex;
};

// Selector Construction
const getNextGrainIndex: Function = createSelector(
  [getSelectedTrackGrains, getSelectedGrainIndex],
  getNextGrainIndexCore
);

export default getNextGrainIndex;
